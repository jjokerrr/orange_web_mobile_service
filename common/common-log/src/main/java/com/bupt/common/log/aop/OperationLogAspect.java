package com.bupt.common.log.aop;
...
import com.bupt.common.core.util.IpUtil;
import com.bupt.common.core.util.MyCommonUtil;
import com.bupt.common.log.annotation.IgnoreResponseLog;
import com.bupt.common.log.annotation.OperationLog;
import com.bupt.common.log.config.OperationLogProperties;
...
public class OperationLogAspect {
    ...
    public Object around(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        if (saveOperationLog) {
            operationLogAnnotation = getMethodAnnotation(joinPoint, OperationLog.class);
        ...
        try {
            ...
            if (this.getMethodAnnotation(joinPoint, IgnoreResponseLog.class) == null) {
