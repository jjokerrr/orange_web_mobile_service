...
import com.bupt.webadmin.upms.dao.SysPermCodeMapper;
import com.bupt.webadmin.upms.dao.SysPermCodePermMapper;
import com.bupt.webadmin.upms.model.SysMenuPermCode;
import com.bupt.webadmin.upms.model.SysPermCode;
import com.bupt.webadmin.upms.model.SysPermCodePerm;
import com.bupt.webadmin.upms.service.SysPermCodeService;
import com.bupt.webadmin.upms.service.SysPermService;
...
public class SysPermCodeServiceImpl extends BaseService<SysPermCode, Long> implements SysPermCodeService {
    ...
    public CallResult verifyRelatedData(
        ...
        if (this.needToVerify(sysPermCode, originalSysPermCode, SysPermCode::getParentId)
                && getById(sysPermCode.getParentId()) == null) {
