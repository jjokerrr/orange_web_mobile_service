...
-- 部门管理表
-- ----------------------------
DROP TABLE IF EXISTS `bupt_sys_dept`;
CREATE TABLE `bupt_sys_dept` (
...
-- 系统用户表
-- ----------------------------
DROP TABLE IF EXISTS `bupt_sys_user`;
CREATE TABLE `bupt_sys_user` (
...
-- 系统角色表
-- ----------------------------
DROP TABLE IF EXISTS `bupt_sys_role`;
CREATE TABLE `bupt_sys_role` (
...
-- 用户与角色对应关系表
-- ----------------------------
DROP TABLE IF EXISTS `bupt_sys_user_role`;
CREATE TABLE `bupt_sys_user_role` (
...
-- 菜单和操作权限管理表
-- ----------------------------
DROP TABLE IF EXISTS `bupt_sys_menu`;
CREATE TABLE `bupt_sys_menu` (
...
-- 角色与菜单对应关系表
-- ----------------------------
DROP TABLE IF EXISTS `bupt_sys_role_menu`;
CREATE TABLE `bupt_sys_role_menu` (
  `role_id` bigint NOT NULL COMMENT '角色Id',
...
-- 系统权限资源表
-- ----------------------------
DROP TABLE IF EXISTS `bupt_sys_perm_code`;
CREATE TABLE `bupt_sys_perm_code` (
...
-- 菜单和权限关系表
-- ----------------------------
DROP TABLE IF EXISTS `bupt_sys_menu_perm_code`;
CREATE TABLE `bupt_sys_menu_perm_code` (
...
-- 系统权限模块表
-- ----------------------------
DROP TABLE IF EXISTS `bupt_sys_perm_module`;
CREATE TABLE `bupt_sys_perm_module` (
...
-- 系统权限表
-- ----------------------------
DROP TABLE IF EXISTS `bupt_sys_perm`;
CREATE TABLE `bupt_sys_perm` (
...
-- 系统权限字和权限资源关联表
-- ----------------------------
DROP TABLE IF EXISTS `bupt_sys_perm_code_perm`;
CREATE TABLE `bupt_sys_perm_code_perm` (
...
-- 权限资源白名单表
-- ----------------------------
DROP TABLE IF EXISTS `bupt_sys_perm_whitelist`;
CREATE TABLE `bupt_sys_perm_whitelist` (
...
-- ----------------------------
BEGIN;
INSERT INTO `bupt_sys_dept` VALUES(1689454707245846530,'公司总部',1,1689454707237457920,CURDATE(),1689454707237457920,CURDATE(),1);
INSERT INTO `bupt_sys_user` VALUES(1689454707237457920,'admin','$2a$10$jMmgSlncpDEVGGfpUg7X9eWIuF3ib18ocww2yznZnLIQxvVIblyS2','管理员',1689454707245846530,NULL,0,0,NULL,NULL,1689454707237457920,CURDATE(),1689454707237457920,CURDATE(),1);
COMMIT;
