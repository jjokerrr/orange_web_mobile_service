...
import com.bupt.webadmin.upms.dao.SysMenuMapper;
import com.bupt.webadmin.upms.dao.SysMenuPermCodeMapper;
import com.bupt.webadmin.upms.dao.SysRoleMenuMapper;
import com.bupt.webadmin.upms.model.SysMenu;
import com.bupt.webadmin.upms.model.SysMenuPermCode;
import com.bupt.webadmin.upms.model.SysRoleMenu;
...
import com.bupt.webadmin.upms.service.SysMenuService;
import com.bupt.webadmin.upms.service.SysPermCodeService;
...
public class SysMenuServiceImpl extends BaseService<SysMenu, Long> implements SysMenuService {
    ...
    public boolean remove(SysMenu menu) {
        ...
        if (menu.getOnlineFormId() != null) {
            ...
            if (CollUtil.isNotEmpty(childMenus)) {
                ...
                LambdaQueryWrapper<SysMenuPermCode> qw2 = new LambdaQueryWrapper<>();
                qw2.in(SysMenuPermCode::getMenuId, childMenuIds);
                sysMenuPermCodeMapper.delete(qw2);
            }
        }
        return true;
    }
    ...
    @Override
    public List<Map<String, Object>> getMenuAndPermListByRoleIds(List<Long> roleIds) {
        if (CollUtil.isEmpty(roleIds)) {
            return new LinkedList<>();
        }
        return sysMenuMapper.getMenuAndPermListByRoleIds(roleIds);
    }
    ...
    public CallResult verifyRelatedData(SysMenu sysMenu, SysMenu originalSysMenu, String permCodeIdListString) {
        ...
        if (StrUtil.isNotBlank(permCodeIdListString)) {
    ...
    @Override
    public List<SysMenu> getReportMenuListByUserId(Long userId, int menuType) {
        return sysMenuMapper.getReportMenuListByUserId(userId, menuType);
    }
